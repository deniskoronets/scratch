...
$this->title = 'Мій SCRATCH';
?>
<div class="site-index">

    <div class="jumbotron">
        <h1>Вивчення SCRATCH 2.0</h1>

        <p class="lead">Цей курс допоможе вам познайомитись із середовищем SCRATCH 2.0 та принципами роботи з ним</p>
        <img src="/img/0001.jpg" style="width: 70%">
<!--        <p><a class="btn btn-lg btn-success" href="http://www.yiiframework.com">Переглянути вправи</a></p>-->
    </div>
